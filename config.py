...
class Config(object):
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "6424682875:AAGGn39z5313kAX5QJfwYq3rMTma6VuBrAY") # ⚠️ Required
    ...
    LOG_CHANNEL = int(os.environ.get('LOG_CHANNEL', '-1002040299414')) # ⚠️ Required
